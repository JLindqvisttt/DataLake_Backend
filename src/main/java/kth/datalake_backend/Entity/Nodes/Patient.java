...
public class Patient {
     ...
     * @see NewMalignancy
     */
    public NewMalignancy getNewMalignancy() {
     ...
     */
    public OverAllSurvivalStatus getOverAllSurvivalStatus() {
     ...
     */
    public void setNewMalignancy(NewMalignancy newMalignancy) {
     ...
     */
    public void setOverAllSurvivalStatus(OverAllSurvivalStatus overAllSurvivalStatus) {
