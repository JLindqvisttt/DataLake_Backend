  ...
  public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
    ...
    http.cors().and().csrf().disable()
      ...
      .sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS).and()
            .authorizeRequests().antMatchers("/api/auth/signIn", "/api/patient/input", "/api/patient/input/symptoms", "/api/patient/getAllDatasets"
            , "/api/patient/getPatientsByDataset", "/api/patient/getAllPatients").permitAll()
